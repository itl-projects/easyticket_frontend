...
SupplierTicketForm.propTypes = {
  submitRef: PropTypes.func,
  closeModal: PropTypes.func
};

export default function SupplierTicketForm({ submitRef, closeModal }) {
    ...
    <FormikProvider value={formik}>
      ...
      <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
        <Grid container rowSpacing={3} columnSpacing={{ xs: 1, sm: 2, md: 3 }} mt={0} px={4}>
          ...
          <Grid item xs={12} lg={6}>
            <TextField fullWidth type="text" label="PNR" {...getFieldProps('pnr')} size="small" />
          </Grid>
          <Grid item xs={12} lg={6}>
